...
<Image src={props.pageContext.frontmatter.image} />
...
## Summary
With the boom of sustainable products and earth-conscious living, there has been a lack of monetary
...
## Design Goal
As a consumer, your purchase decisions can make an impact on climate change. What is considerable a sustainable product and whether products are a product is developed in a sustainable way is confusing. 
In the age of virtual-everything, making banking an accessible and user 
friendly experience is crucial. My objective for this project was to design the end-to-end experience of a mobile 
banking and investment platform that would encourage and reward users for sustainable purchases. 
...
**Environmental impact is less of a priority when purchasing** — Other factors like price, brand, and perception of quality are more important than environmental impact when purchasing a product.
...
**Onboarding** - We need to think about how a user might **initially set up their first account and sign in information**. The user provides all of the necessary information required to open an account and verify their identity.
<Image src="Onboarding.png" />



**Activate Card** - Once a user has received their physical card, **how might they activate it in app**?

A user would need to be provided with a unique ID with their physical card. They then confirm that ID in-app in order to activate their debit card.
<Image src="Activate_Card.png" />


**Transactions** - After making purchases, we can think about how a user would want to **interact with transactions and what information they would want to know**. From user interviews, it's important for users to be able to view the time and date of transactions, the amount, and the vendor. For the purpose of rewards, each transaction would have a corresponding cash back percentage that the user received.
<Image src="Transactions and Rewards.png" />


**Investing** - Again a user would need to start with opening an investment account. However, we would then need to take them through a flow of determining what kind of account is right for them, their investment strategy based upon their risk score, and their portfolio allocation. I decided to create a questionnaire that helped align the portfolio allocation to the issues the user indicated were most impactful to them.  
...
## Wireframes
I focused on sketching the onboarding flow and the flow for opening an investment account. I made sure the logic of these flows were sound before proceeding to final designs. 
...
## Moodboard
This was the first iteration of the moodboard that sparked the inspiration for the visual designs. I wanted to incorporate different shades of green with a black and white neutral colour palette. I really enjoyed these pops of orange, pastel pink, and red for highlights within the app. 

Later in my design stages, the visual aesthetic became simpler with a palette of solid colours, rather than gradients. 
...
## High Fidelity Mocks
**Onboarding Flow** - This flow is how the user is initially introduced to the app. They choose an account, a card, and learn about Perpetua's rewards and earnings. 
...
**Interact with Transactions**  - I based the initial home screen design off of my wireframe, but I needed to make sure that a user scrolling through their latest transactions could easily click-into a single transaction and see more information. It was important to not only include purchase information but also a way for the user to learn more about their rewards and why they had received X percent cash back on a certain purchase.

<Image src="Transactions_mock.png" />

**Rewards Redemption**  - A user can see their accumulated rewards, see from what purchases they received their cash back, and redeem their rewards. I wanted to give the user freedom in regard to what account they could they could redeem their cash back into -- a Perpetua investment account or an external account they've linked to the app. I added for the user to enter their 4-digit account PIN as an extra measure for security while they redeem their cash.  

<Image src="Reward Redemption 1.png" />
<Image src="Reward Redemption 2.png" />

**Open an Investment Account**  - The user navigates to the Investments page and, similar to the User Flow, they first select what account is right for them. Their options are investment accounts and high-interest savings accounts. 

The user goes through a few questions that assesses their investment experience, their goals, and their intended timelin in order to determine their investment risk score. They finally select what issues they want to fund with their investment money. Users selects amongst a variety of sustainability-related issues which will impact their portfolio allocation. Once they have confirmed this information, they are redirected to the Investment home screen. 

<Image src="Investing 1.png" />
<Image src="Investing 2.png" />


**Activating Card** - I needed to think about how I would make it clear for a user what information they needed in order to activate their card. For this process, the user needs to not only include a unique 8-digit ID on their physical card, but also the 4-digit PIN that they set when they created their account. 
