...
<Image src={props.pageContext.frontmatter.description} />
...
**Chat Onboarding** - The user needs to be introduced and onboarded to both the application and the chat. I thought being onboarded through a conversation with the chatbot was the best way for the user to get acquainted with the way the rest of the app would be navigated. 

So through the chatbot, the user learns of the purpose of the app, sets check-in reminders, enables notifications, and completes their anxiety/depression assessments. 
<Image src="chat_onboarding.png" />



**Strategies** - There are a couple ways for the user to be introduced to Strategies. One is while they chat with the chatbot, they are recommended a CBT strategy based on their responses and what exercises they have previously completed. Users can also navigate away from the chatbot and navigate to the Browse page where they can search through all available Strategies. However, regardless of how they arrive at a Strategy exercise, **Strategies are completed through the chat itself**. 
...
**Contacting a Professional** - Regardless of the efficacy of the Chatter application, there will be cases when users need outside help. I wanted it to be easy for users to be able to locate and contact professionals within the app. For this I thought it would be best if, in the Onboarding stage, the user linked their GP portal account, therefore if they needed to reach out to their doctor, they could easily click into their Profile and select their Doctor Portal to be redirected. 

If a user wants to instead reach counselling, I wanted to include navigation to locating local counselling help by using geolocating withing the app. Then users could identify couselling or therapist services near them and contact them more easily.

I also designed an SOS feature. Within the chat itself, if a user feels the need to send an 'SOS', the chatbot will contact their doctor through the Doctor Portal. This will notify the GP to get in touch with the user. 
...
## Wireframes
I focused on sketching out the main layouts of the Chat frames as how users would interact with the Strategies from the Chat. This layout evolved as I went onto design the high-fidelity mockups because I wanted to integrate the Strategies into the Chat more and make the Strategy exercises more conversational rather than have them take the user to a different frame. 
...
## High Fidelity Mocks
**Chat Onboarding** - The onboarding flow takes the user through the regular sign up process but also notifes the user of important information like how Chatter is intended to **augment** their treatment. As indicated in the Chat Onboarding User Flow, how Chatter works and how the user is recommended Strategies is told to the user through the chat itself. The user is provided some predetermined responses to ease through this initial section. 
...
This flow shows how the user can interact with the chatbot to not only complete different exercises but also to agree to or to turn down suggestions of the chatbot. The mocks also show how the user can navigate to the Visualization strategy page, be redirected to the Chat, and begin the exercise.


<Image src="chat_strategy.png" />
<Image src="viz_chat.png" />

**Navigating to Strategies** - Users are able to navigate away from the main Chat page, scroll through their summary page, and navigate to Browse. They can look through the available Strategy exercises on this page. 

<Image src="browse_strat.png" />

**Contacting a Professional** - From the main Chat page, users can click-into their Profile on the top-right. They can then access their Doctor Portal which will then either open the native application if it is downloaded on their phone or it will open up their browser.

If the user chooses to instead search for resources, they can select to search for couselling services near them which would open a local, interactive map showing locations of clinic, therapist, and couselling services, with a list of these services beneath. 
...
- Not enough colors to really differentiate across screens, indicate what is interactive
- It doesn't seem like the chat is the center of the app
- Pagination up at the top makes it unclear how to navigate

For Version 2 of Chatter, I redesign how Strategies were integrated with the application. Rather than having a dedicated Strategy page pop up when the user wanted to do an exercise, instead, the user would be redirected back to the chat. I also redesigned the colour palette and introduced more variation throughout the app to make it more visually interesting. I also removed the pagination up at the top and opted for a fixed menu and Profile icon. I agreed that pagination didn't acheive a clear way to navigated between the Chat, Profile, and Strategies. 
